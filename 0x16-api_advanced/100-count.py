#!/usr/bin/python3
"""
Recursive function to count and sort keywords
in the titles of hot articles from a subreddit.
"""
import requests
...
def count_words(subreddit, word_list, after='', counts={}):
    """
    Queries the Reddit API, counts occurrences of keywords
    in hot articles' titles.
    """
